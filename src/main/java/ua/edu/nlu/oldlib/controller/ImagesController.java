...
public class ImagesController {
    ...
    public void getImage(HttpServletResponse response, HttpServletRequest request, @PathVariable("bookId") int bookId,
        ...
        if (session != null) {
            System.out.println("IMAGE CONTROLLER SESSION ........... " + session.getId());
        }
